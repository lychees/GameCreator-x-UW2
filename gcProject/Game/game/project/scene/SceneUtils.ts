...
class SceneUtils {
     ...
     */
    gridSceneObjects: ProjectSceneObject_1[][][] = [];
    /**
     * 场景对象上次所在的格子坐标
     */
     ...
     * @return [boolean] 
     */
    static twoPointHasObstacle(x1: number, y1: number, x2: number, y2: number, scene: ProjectClientScene, except: ProjectSceneObject_1 = null, exceptToP: boolean = false): boolean {
        //遮挡是地图的遮挡
     ...
     * @return [boolean] 
     */
    isObstacle(p: Point, except: ProjectSceneObject_1 = null): boolean {
     ...
     * @return [boolean] 
     */
    isObstacleGrid(gridP: Point, except: ProjectSceneObject_1 = null): boolean {
    ...
    /**
     * 检查该格子是否具备动态穿透属性
     * 只包含 ProjectSceneObject_1，因为其他场景对象类未拥有障碍特性
     * -- 只要有桥对象则视为穿透
     * -- 否则只要有障碍物则视为有障碍
     * @param gridP 当前格子
     ...
     */
    getGridDynamicObsStatus(gridP: Point, excepter: ProjectSceneObject_1 = null, gridSceneObjects: ProjectSceneObject_1[] = null): number {
        // 忽略超过边界的情况
     ...
     */
    touchCheck(checker: ProjectSceneObject_1, useGridObstacle: boolean, posP: Point, posGridP: Point = null, trendP: Point = null, trendGridP: Point): { isObstacle: boolean, touchSceneObjects: ProjectSceneObject_1[], alreadyCalcPosRect: boolean } {
     ...
     * @return 获取周围的位置
     */
    static getAroundPositions(mode: number, so1: ProjectSceneObject_1, so2: ProjectSceneObject_1, positionSize: number = 1, calcWantToGo: boolean = true, gridSize: number = Config.SCENE_GRID_SIZE): Point[] {
        ...
        var sceneObjects: ProjectSceneObject_1[] = Game.currentScene.sceneObjects as any;
     ...
     */
    private collsionCheckGrid(checker: ProjectSceneObject_1, posP: Point, posGridP: Point = null, trendP: Point = null, calcTrendP: boolean = true) {
        ...
        if (calcTrendP) {
            ...
            touchSceneObjects = res.touchSceneObjects.concat(trendPTouchRes.touchSceneObjects);
     ...
     */
    private collsionCheckRect(checker: ProjectSceneObject_1, p: Point, trendP: Point, gridP: Point = null) {
        var res = { isObstacle: false, touchSceneObjects: [], alreadyCalcPosRect: false };
        // 不允许接触的场合
        if (!checker.touchEnabled) return res;
