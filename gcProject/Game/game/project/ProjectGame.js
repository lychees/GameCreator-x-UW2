...
var ProjectGame = (function (_super) {
    ...
    function ProjectGame() {
        _super.call(this);
        this.EVENT_REMOVE_ACTOR_ITEM = "GameEVENT_REMOVE_ACTOR_ITEM";
        this.EVENT_CARRY_ACTOR_ITEM = "GameEVENT_CARRY_ACTOR_ITEM";
        this.EVENT_LEARN_SKILL = "GameEVENT_LEARN_SKILL";
        this.EVENT_FORGET_SKILL = "GameEVENT_FORGET_SKILL";
        this.EVENT_WEAR_ACTOR_EQUIP = "GameEVENT_WEAR_ACTOR_EQUIP";
        this.EVENT_TAKE_OFF_ACTOR_EQUIP = "GameEVENT_TAKE_OFF_ACTOR_EQUIP";
