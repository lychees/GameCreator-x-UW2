var GameBattleHelper = (function () {
    ...
    GameBattleHelper.getEffectRange = function (firstGrid, range, obstacleMode, rangeMode, minRange, customRangeData, isThroughObstacle) {
    ...
    GameBattleHelper.getDestinationThroughGridMap = function (posGrid, range, obstacleMode, caleDistance, customRangeData) {
        if (obstacleMode === void 0) { obstacleMode = 0; }
    ...
    GameBattleHelper.createEffectGrid = function (gridX, gridY, mode) {
        if (mode == 0) {
