...
var ProjectSceneObjectBehaviors = (function (_super) {
    ...
    ProjectSceneObjectBehaviors.prototype.behavior37 = function (v, keepMoveActWhenCollsionObstacleAndIgnoreCantMove) {
    ...
    ProjectSceneObjectBehaviors.prototype.behavior47 = function (useVar, actionID, actionIDVarID, once) {
        var _this = this;
    ...
    ProjectSceneObjectBehaviors.prototype.behaviorMoveD = function (dx, dy) {
        if (!this.so.scene)
            return;
