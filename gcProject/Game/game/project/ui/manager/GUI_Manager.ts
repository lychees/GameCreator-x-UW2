...
class GUI_Manager {
     ...
     * @return [string] 
     */
    static skillDesc(skill: Module_技能, actor: Module_角色): string {
     ...
     * @return [string] 
     */
    static equipDesc(equip: Module_装备): string {
        var introArr = [];
     ...
     * @return [string] 
     */
    static itemDesc(item: Module_道具): string {
        return item.intro;
    }
    //------------------------------------------------------------------------------------------------------
    // 状态面板相关
     ...
     * @return [string] 
     */
    static statusDesc(status: Module_状态): string {
