...
var GUI_BattleReady = (function (_super) {
    ...
    GUI_BattleReady.prototype.setReadyStep = function (step) {
        ...
        new SyncTask(task, function (step) {
            ...
            Callback.CallLaterBeforeRender(function () {
                CommandPage.startTriggerFragmentEvent(fragmentEvent, Game.player.sceneObject, Game.player.sceneObject, Callback.New(function () {
    ...
    GUI_BattleReady.prototype.nextSceneObjectCtrlOri = function () {
        ...
        if (this.currentChangeOriSceneObject && WorldData.stopChangeBattlerOriEvent) {
            CommandPage.startTriggerFragmentEvent(WorldData.stopChangeBattlerOriEvent, this.currentChangeOriSceneObject, this.currentChangeOriSceneObject, Callback.New(function () {
