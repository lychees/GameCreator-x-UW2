...
(function (CommandExecute) {
    ...
    function customCommand_5001(commandPage, cmd, trigger, triggerPlayer, playerInput, cp) {
        ...
        CommandPage.startTriggerFragmentEvent(WorldData.beforeStartBattleEvent, trigger.trigger, trigger.executor, Callback.New(function () {
    ...
    function customCommand_5002(commandPage, cmd, trigger, triggerPlayer, playerInput, cp) {
        ...
        GameBattle.stop(function () {
            ...
            CommandPage.startTriggerFragmentEvent(WorldData.afterEndBattleEvent, Game.player.sceneObject, Game.player.sceneObject, Callback.New(function () {
